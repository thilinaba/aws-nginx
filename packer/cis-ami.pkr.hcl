# This will build a CIS Level 1 hardened Ubuntu base image with Docker installed

# Validate the template
#   eg: packer validate -var-file=variables.json cis-ami.pkr.hcl 
...
# Use the Ubuntu 22.04 AMI as the source_ami
variable "source_ami" {
  type = string
}
